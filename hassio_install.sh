...
URL_RAW_BASE="https://code.aliyun.com/neroxps/supervised-installer/raw/master/files"
...
docker pull "$HASSIO_DOCKER" > /dev/null
docker tag "$HASSIO_DOCKER" "$HASSIO_DOCKER:latest" > /dev/null
